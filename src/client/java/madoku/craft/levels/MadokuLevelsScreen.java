...
public final class MadokuLevelsScreen extends Screen {
	private static final ResourceLocation BACKGROUND_TEXTURE_ATTRIBUTES =
		ResourceLocation.fromNamespaceAndPath("madoku-craft", "textures/containers/player_levels_attributes.png");
	private static final ResourceLocation BACKGROUND_TEXTURE_VANILLA =
		ResourceLocation.fromNamespaceAndPath("madoku-craft", "textures/containers/player_levels_vanilla.png");
	private static final ResourceLocation ENTRY_TEXTURE =
		ResourceLocation.fromNamespaceAndPath("madoku-craft", "textures/rows/player_entries.png");
	...
	private ResourceLocation backgroundTexture(MadokuLevelsClientState.Snapshot snapshot) {
