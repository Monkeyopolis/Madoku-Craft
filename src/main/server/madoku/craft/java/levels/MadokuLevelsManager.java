...
public final class MadokuLevelsManager {
	...
	public static boolean useAttributesContainer() {
		return madoku.craft.java.attributes.MadokuAttributesManager.isEnabled()
			&& (madoku.craft.java.attributes.HungerAPIManager.isEnabled()
				|| madoku.craft.java.attributes.LuckAPIManager.isEnabled());
	}
}
