...
public final class MobConfigStray {
	...
	public static JsonObject buildDefaults() {
		...
		stray.addProperty(MobConfigManager.FIELD_CUSTOM_MOB_DROPS, true);
		stray.addProperty(MobConfigManager.FIELD_DIFFICULTY_SCALING, true);
		...
		stray.add(MobConfigManager.FIELD_DIFFICULTY_SCALE, difficultyScale);

		JsonObject regionalDifficultyScale = new JsonObject();
		regionalDifficultyScale.addProperty(MobConfigManager.FIELD_ENABLED, true);
		stray.add(MobConfigManager.FIELD_REGIONAL_DIFFICULTY_SCALING, regionalDifficultyScale);
		...
		defaultGroup.add(
			...
			buildStrayMobStatsDefaults()
		);
		defaultGroup.add(
			MobConfigManager.FIELD_SPAWN_RULES,
			MobConfigManager.mobSpawnRules()
				.spawnWeight(90.0d)
				.equipmentSet(buildStrayEquipmentSetDefaults())
				.build()
		);
		defaultGroup.add(
		...
		stray.add(MobConfigManager.FIELD_DEFAULT_GROUP, defaultGroup);
		stray.add("stray-jockey", buildStrayJockeyVariantDefaults());

		root.add(MobConfigManager.FILE_STRAY, stray);
		return root;
	}
	...
	private static JsonObject buildStrayMobStatsDefaults() {
		...
		mobStats.add(
			...
			MobConfigManager.buildMobEffectDefaults("minecraft:weakness", 15)
		);
		return mobStats;
	}
	...
	private static JsonObject buildStrayEquipmentSetDefaults() {
		...
		equipmentSet.addProperty(MobConfigManager.FIELD_MOB_EQUIPMENT, "minecraft-equipment-stray.json");
	...
	private static JsonObject buildStrayJockeyVariantDefaults() {
		...
		passengerMob.addProperty(MobConfigManager.FIELD_ADULT_GROUP, "minecraft:stray");
