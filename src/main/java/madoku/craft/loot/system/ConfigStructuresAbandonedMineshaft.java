...
public final class ConfigStructuresAbandonedMineshaft {
	private static final String TABLE_ID = "minecraft:structure_chests/abandoned_mineshaft";

	private ConfigStructuresAbandonedMineshaft() {
	}
