...
public final class ConfigStructuresNetherFortress {
	private static final String TABLE_ID = "minecraft:structure_chests/nether_fortress";

	private ConfigStructuresNetherFortress() {
	}
