...
public final class ConfigStructuresUnderwaterRuin {
	private static final String TABLE_ID = "minecraft:structure_chests/underwater_ruin";

	private ConfigStructuresUnderwaterRuin() {
	}
