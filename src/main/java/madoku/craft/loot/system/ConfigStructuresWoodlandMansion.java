...
public final class ConfigStructuresWoodlandMansion {
	private static final String TABLE_ID = "minecraft:structure_chests/woodland_mansion";

	private ConfigStructuresWoodlandMansion() {
	}
		...
		return JsonFormatBuilder.object()
			...
			.array(LootTableConfigManager.FIELD_GROUPS, groups -> groups
				...
				.add(LootTableConfigStructures.group("rare", 30, LootTableConfigStructures.entries(
					LootTableConfigStructures.item("minecraft:emerald", 1, 4, 6)
				)))
