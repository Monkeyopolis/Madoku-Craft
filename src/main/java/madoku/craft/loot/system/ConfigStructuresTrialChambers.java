...
public final class ConfigStructuresTrialChambers {
	private static final String TABLE_ID = "minecraft:structure_chests/trial_chambers";

	private ConfigStructuresTrialChambers() {
	}
		...
		return JsonFormatBuilder.object()
			...
			.array(LootTableConfigManager.FIELD_GROUPS, groups -> groups
				...
				.add(LootTableConfigStructures.group("rare", 30, LootTableConfigStructures.entries(
					LootTableConfigStructures.item("minecraft:wind_charge", 1, 2, 6)
				)))
				...
				.add(LootTableConfigStructures.group("epic", 20, LootTableConfigStructures.entries(
					LootTableConfigStructures.item("minecraft:emerald", 1, 2, 6)
				)))
				.add(LootTableConfigStructures.group("mythic", 25, LootTableConfigStructures.entries(
					LootTableConfigStructures.item("minecraft:golden_sword", 100, 1, 1, "mythic"),
					LootTableConfigStructures.item("minecraft:golden_spear", 100, 1, 1, "mythic"),
					LootTableConfigStructures.item("minecraft:golden_helmet", 100, 1, 1, "mythic"),
					LootTableConfigStructures.item("minecraft:golden_chestplate", 100, 1, 1, "mythic"),
					LootTableConfigStructures.item("minecraft:golden_leggings", 100, 1, 1, "mythic"),
					LootTableConfigStructures.item("minecraft:golden_boots", 100, 1, 1, "mythic"),
					LootTableConfigStructures.item("minecraft:golden_pickaxe", 100, 1, 1, "mythic"),
					LootTableConfigStructures.item("minecraft:golden_axe", 100, 1, 1, "mythic"),
					LootTableConfigStructures.item("minecraft:golden_shovel", 100, 1, 1, "mythic")
				)))
				.add(LootTableConfigStructures.group("mythic", 10, LootTableConfigStructures.entries(
					LootTableConfigStructures.item("minecraft:diamond_sword", 100, 1, 1, "rare"),
					LootTableConfigStructures.item("minecraft:diamond_spear", 100, 1, 1, "rare"),
					LootTableConfigStructures.item("minecraft:diamond_helmet", 100, 1, 1, "rare"),
					LootTableConfigStructures.item("minecraft:diamond_chestplate", 100, 1, 1, "rare"),
					LootTableConfigStructures.item("minecraft:diamond_leggings", 100, 1, 1, "rare"),
					LootTableConfigStructures.item("minecraft:diamond_boots", 100, 1, 1, "rare"),
					LootTableConfigStructures.item("minecraft:diamond_pickaxe", 100, 1, 1, "rare"),
					LootTableConfigStructures.item("minecraft:diamond_axe", 100, 1, 1, "rare"),
					LootTableConfigStructures.item("minecraft:diamond_shovel", 100, 1, 1, "rare")
				))))
			.build();
	}
}
