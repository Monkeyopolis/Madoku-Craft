...
public final class ConfigStructuresBuriedTreasure {
	private static final String TABLE_ID = "minecraft:structure_chests/buried_treasure";

	private ConfigStructuresBuriedTreasure() {
	}
