...
public final class ConfigStructuresStronghold {
	private static final String TABLE_ID = "minecraft:structure_chests/stronghold";

	private ConfigStructuresStronghold() {
	}
