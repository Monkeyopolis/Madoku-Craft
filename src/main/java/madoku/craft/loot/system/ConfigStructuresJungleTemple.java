...
public final class ConfigStructuresJungleTemple {
	private static final String TABLE_ID = "minecraft:structure_chests/jungle_temple";

	private ConfigStructuresJungleTemple() {
	}
