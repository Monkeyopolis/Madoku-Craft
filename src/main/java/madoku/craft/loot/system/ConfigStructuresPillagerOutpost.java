...
public final class ConfigStructuresPillagerOutpost {
	private static final String TABLE_ID = "minecraft:structure_chests/pillager_outpost";

	private ConfigStructuresPillagerOutpost() {
	}
