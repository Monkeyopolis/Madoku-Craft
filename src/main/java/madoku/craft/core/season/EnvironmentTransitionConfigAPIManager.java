...
public final class EnvironmentTransitionConfigAPIManager {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(EnvironmentTransitionConfigAPIManager.class);
	private static volatile Settings settings = defaults();
	private static volatile Settings clientSynchronizedSettings;

	private EnvironmentTransitionConfigAPIManager() { }
	...
	private static void writeSeasonAdjustments(JSONFormatAPIManager.ObjectBuilder parent, Map<String, Adjustment> values, boolean enabled) {
