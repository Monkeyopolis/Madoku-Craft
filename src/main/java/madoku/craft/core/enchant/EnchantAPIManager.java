...
public final class EnchantAPIManager {
	...
	public static void initialize() {
		...
		SyncConfigAPIManager.register(
			...
			EnchantAPIManager::applyClientSynchronizedSnapshot,
			EnchantAPIManager::resetClientSynchronizedState
		);
	...
	public static void onServerTick(MinecraftServer server) {
		EnchantBooksAPIManager.onServerTick(server);
	}
	...
	public static boolean isEnabled() {
		return EnchantConfigAPIManager.isEnabled();
	}

	public static void resetClientSynchronizedState() {
		BooksConfigAPIManager.resetClientSynchronizedState();
	}

	public static void applyClientSynchronizedSnapshot(String snapshot) {
		BooksConfigAPIManager.applyClientSynchronizedSnapshot(snapshot);
	}
