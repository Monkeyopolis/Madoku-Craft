...
public final class MadokuEnchantManager {
	public static final String ENCHANT_FOLDER_NAME = "madoku-craft-enchant";
	...
	public static void initialize() {
		...
		EnchantSmithingManager.initialize();
	}

	public static void reset() {
		EnchantSmithingManager.reset();
	...
	public static void onServerStarted(MinecraftServer server) {
		...
		EnchantSmithingManager.onServerStarted(server);
	}
	...
	/** Shared dependency check for smithing extensions that operate on managed item or pet stacks. */
	public static boolean isItemOrPetSystemEnabled() {
		return MadokuItemsManager.isEnabled() || MadokuPetManager.isEnabled();
	}
