...
public final class EnchantConfigManager {
	...
	private static final String SMITHING_GROUP = "smithing-table";
	...
	public static boolean isSmithingTableEnabled() {
		return settings.enabled && settings.smithingTableEnabled;
	}
	...
	private static JsonObject buildDefaults() {
		return JSONFormatManager.object()
			...
			.group(SMITHING_GROUP, group -> group.put("enabled", true))
			.build();
	}
	...
	private static final class EnchantSettings {
		...
		private final boolean smithingTableEnabled;

		private EnchantSettings(boolean enabled, boolean enchantmentTableEnabled, boolean smithingTableEnabled) {
			this.enabled = enabled;
			this.enchantmentTableEnabled = enchantmentTableEnabled;
			this.smithingTableEnabled = smithingTableEnabled;
		}
	}
}
