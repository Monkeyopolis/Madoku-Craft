package madoku.craft.api.helper;
...
public final class HelperProjectileManager {
	...
	private HelperProjectileManager() {
	}
	...
	public static void tick(MinecraftServer server) {
		...
		tickHomingProjectiles(HelperProjectileManager::findEntity);
		tickManagedProjectiles(HelperProjectileManager::findEntity);
	}
