...
public final class MadokuLevelsManager {
	...
	public enum LevelStat {
		...
		public static List<LevelStat> visibleStats() {
			...
			if (!madoku.craft.attributes.hunger.MadokuHungerManager.isEnabled()) visible.remove(HUNGER);
			if (!madoku.craft.attributes.luck.MadokuLuckManager.isEnabled()) visible.remove(LUCK);
	...
	public static boolean useAttributesContainer() {
		return madoku.craft.attributes.MadokuAttributesManager.isEnabled()
			&& (madoku.craft.attributes.hunger.MadokuHungerManager.isEnabled()
				|| madoku.craft.attributes.luck.MadokuLuckManager.isEnabled());
	}
}
